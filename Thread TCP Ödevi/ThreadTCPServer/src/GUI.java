...
public class GUI {
    ...
    private static  JButton guncelle_butonu;
    ...
    public static JLabel getServer_durum_yazisi() {
        if(server_durum_yazisi == null){
            ...
            server_durum_yazisi.setBounds(12, 85, 160, 35);
    ...
    public static JLabel getMesajlar_yazisi() {
        if(mesajlar_yazisi == null){
            ...
            mesajlar_yazisi.setBounds(12, 125, 117, 20);
    ...
    public static JTextArea getGelen_mesajlar_alani() {
        ...
        if(gelen_mesajlar_alani == null){
            ...
            gelen_mesajlar_alani.setBounds(12, 150, 300, 250);
        }
    ...
    public static JLabel getBaglantilar_yazisi() {
        if(baglantilar_yazisi == null){
            ...
            baglantilar_yazisi.setBounds(350, 125, 100, 20);
    ...
    public static JTextArea getBaglantilar_alani() {
        ...
        if(baglantilar_alani == null){
            ...
            baglantilar_alani.setBounds(350, 150, 250, 250);        
        }
    ...
    public static JButton getCik_butonu() {
        if(cik_butonu == null){
            ...
            cik_butonu.setBounds(460, 430, 137, 26);
    ...
    public static JButton getGuncelle_butonu() {
        if(guncelle_butonu == null){
            guncelle_butonu = new JButton("Guncelle");
            guncelle_butonu.setBounds(460, 402, 137, 26);
            
            //Uygulamayı kapatma kodu
            guncelle_butonu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                GUI.getBaglantilar_alani().setText("");
                for(String s: TCPServerThread.isimler){
                    GUI.getBaglantilar_alani().setText(GUI.getBaglantilar_alani().getText()+s+"\n");
                }
                
            }
        });
        }
        return guncelle_butonu;
    }
    ...
    public static void setGuncelle_butonu(JButton guncelle_butonu) {
        GUI.guncelle_butonu = guncelle_butonu;
    }
    ...
    public static JLabel getSol_server_resmi() {
        ...
        if (sol_server_resmi == null) {
            ...
            Image foto = new ImageIcon(GUI.class.getResource("/Images/boyutlu_server2.png")).getImage();
    ...
    public static JLabel getSag_server_resmi() {
        if (sag_server_resmi == null) {
           ...
           // Image foto = new ImageIcon(GUI.class.getResource("/Images/boyutlu_server.png")).getImage();
